				...
				<div class="col-sm-12">
					<form class="form-horizontal" action="singUp.php" method="post">
						<fieldset>
							...
							<!-- Form Name -->
							<h2><legend style="color:black">Regjistrohu</legend></h2>
								...
								<div class="panel-body">
									...
									<!-- Firs Name-->
										<div class="form-group">
											<label for="firstName" style= "color:BLACK" class="col-sm-3 control-label">Emri</label>
											<div class="col-sm-9">
												<input name="firstname" type="text" id="firstName" placeholder="Emri" class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<label for="firstName" style= "color:BLACK" class="col-sm-3 control-label">Mbiemri</label>
											<div class="col-sm-9">
												<input name="lastname" type="text" id="firstName" placeholder="Mbiemri" class="form-control" >
											</div>
										</div>
										<div class="form-group">
											<label for="email" style= "color:BLACK" class="col-sm-3 control-label">E-mail</label>
											<div class="col-sm-9">
												<input name="email" type="email" id="email" placeholder="E-mail" class="form-control" >
											</div>
										</div>
										<div class="form-group">
											<label for="password" style= "color:BLACK" class="col-sm-3 control-label">Fjalëkalim</label>
											<div class="col-sm-9">
												<input name="password" type="password" id="password" placeholder="Fjalëkalim" class="form-control" >
											</div>
										</div>
										<div class="form-group">
											<label for="passwordConfirm" class="col-sm-3 control-label">Konfirmo falëkalimin</label>
											<div class="col-sm-9">
												<input type="password" name="confirmpassword" id="passwordConfirm" class="form-control" placeholder="Konfirmo falëkalimin"  >
												
											</div>
										</div>
										<div class="form-group">
											<label for="birthDate" style= "color:BLACK" class="col-sm-3 control-label">Data e lindjes</label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label for="state" style= "color:BLACK" class="col-sm-3 control-label">Shteti</label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label for="country" style= "color:BLACK" class="col-sm-3 control-label">Qyteti</label>
											<div class="col-sm-9">
												<select name="country" class="form-control bfh-states" data-country="countries_states1"></select>
											</div>
										</div>
										<div class="form-group">
											<label for="phone" style= "color:BLACK" class="col-sm-3 control-label">Nr. i telefonit</label>
											<div class="col-sm-9">
												...
												<div class="row">
													<div class="col-sm-4">
														<label for="femaleRadio"class="radio-inline" style= "color:Black">
															<input name="gender" type="radio" id="femaleRadio" value="Female">Femër
														</label>
													</div>
													<div class="col-sm-4">
										...
										<div class="form-group last">
											<div class="col-sm-offset-3 col-sm-9">
												<button name="singup"type="submit" class="btn btn-success btn-md">Regjistrohu</button>
												<button type="reset" class="btn btn-danger">Reset</button>
											</div>
										</div>
										<div class="col-sm-offset-3 col-sm-9">
											<div style= "color:BLACK" class="form-group last">Jeni të regjistruar ? <a href="login.php">   Hyni këtu</a>
											</div>
										</div>
									</form> <!-- /form -->
								</div>
