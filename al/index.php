...
<header id="first">
    <div class="header-content">
        <div class="inner">
            ...
            <h4>Platforma e parë e transportit të përbashkët në Shqipëri.</h4>
            <hr>
            <a href="offeraride.php" class="btn btn-primary btn-xl">Ofro</a> &nbsp;
            <a href="findaride.php" class="btn btn-primary btn-xl page-scroll">Kërko</a>
        </div>
